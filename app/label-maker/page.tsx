...
export default function NutritionLabelSoftware() {
  ...
  const tabs: { [key: string]: TabContent } = {
    "All Features": {
      ...
      secondaryText:
        "With Foodplanet, you can use our nutrition labeling software to full-form nutrition labels for your products to comply with food regulations and grow your business." +
        "<br/></br>" +
    ...
    "Nutrition Analysis": {
      ...
      secondaryText:
        "With the best nutrition analysis software, you can accurately break down the nutritional contents of the food you’re producing, and better understand it. Foodplanet's user-friendly software allows you to conveniently analyze products and increase transparency with customers.",
    ...
    Labeling: {
      ...
      secondaryText:
        "Are you a food business owner in need of a high-quality nutrition label for your products? It’s simple and fast to full-form your very own custom nutrition label with Foodplanet’s nutrition label templates.",
      faq: LabelingFaq,
    },
    Costing: {
      page: <Costing />,
      ...
      secondaryText:
        "With Foodplanet’s ingredient cost calculator, you can get a detailed breakdown that provides you with the cost of food products by batch and by package. This allows you to come up with an effective pricing strategy for your food products and optimize profits for your business.",
      faq: CostingFaq,
    },
    "Ingredient Lists": {
      page: <IngredientList />,
      ...
      secondaryText:
        "With Foodplanet’s free ingredients list template, you can quickly full-form your own custom ingredients list and automatically generate nutrition labels that follow FDA guidelines.",
    ...
    "Recipe Management": {
      ...
      secondaryText:
        "With Foodplanet’s secure cloud-based recipe management software, you can be completely flexible in how you manage products and ingredients. Access products from any device, at any time, from any location.",
  ...
  return (
    <div className={"flex flex-col"}>
      <TopHero
        mainText={tabContent.mainText}
        secondaryText={tabContent.secondaryText}
      />
      <Tabs
