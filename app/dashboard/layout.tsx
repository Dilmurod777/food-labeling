        ...
        {Object.keys(tabs).map((tab, ti) => {
          ...
          return (
            <div
              ...
              className={`text-normal relative mt-[10px] cursor-pointer px-6 py-2 text-sm text-black ${isActive && "text-main after:absolute after:bottom-0 after:left-0 after:h-2 after:w-full after:bg-[#fafafa] after:content-['']"}`}
              style={{
