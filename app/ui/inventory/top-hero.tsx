    ...
    return <div className={"flex flex-col items-center w-full px-12 pb-12"}>
        ...
        <div className={"flex justify-center gap-16 mt-16"}>
            ...
            <div className={"flex flex-col w-1/2 text-xl items-center"}>
                ...
                <p className={"mb-3"}>We help you run and grow your business too — <strong>tracking inventory and how much it&apos;s
                    worth</strong>,
                    managing production, planning ahead for purchasing, and reporting.</p>
                <p><strong>With our cloud-based software, all this is a breeze.</strong> Provide role-based access to staff, access it anywhere,
                    and
