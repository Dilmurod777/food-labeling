...
export default function FoodManufacturers() {
  const items: Manufacturer[] = [
    {
      ...
      feedback:
        "I know that this is the software that will make our 30 year old company more successful.",
    ...
    },
    {
      image: PieInTheSky,
      feedback:
        "I love the recall section and how easy it is to find everything from a particular lot.",
    ...
    },
    {
      image: GrassFeather,
      feedback:
        "We're a meals company and this is just enough to make us dangerous!",
      author: "Jeff Smith",
      job: "Owner",
    ...
    },
    {
      ...
      feedback:
        "I love the production runs - knowing how much I need of each ingredient, including labor and packaging, and closing production runs to automatically update inventory.",
      author: "Tracy Turner",
    ...
    },
    {
      image: FrozenGarden,
      feedback:
        "I love production plans and being able to plan weeks in advance with ingredient and purchasing requirements.",
    ...
    },
    {
      image: Pops,
      feedback:
        "We started using it for inventory, but it's also integral for documenting products and running things on the floor.",
  ...
  return (
    <div
      className={
        "flex w-full flex-wrap items-center justify-between gap-2 bg-main-blue px-12 py-12"
      }
    >
      {items.map((item, i) => (
        <div
          key={`manufacturer-${i}`}
          className={"flex w-[30%] flex-col items-center gap-4 text-center"}
        >
          <Image src={item.image} alt={item.company} width={148} height={148} />

          <p className={"text-sm font-thin italic text-white"}>
            &#10077;{item.feedback}&#10078;
          </p>
