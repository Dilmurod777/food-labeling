...
export default function RecipeLabel({recipe}: Props) {
    return <div className={"w-[325px] h-full flex-grow border-[1px] border-black p-2"} id={"recipe-label"}>
        <h1 className={"text-3xl font-bold text-black"}>Nutrition Facts</h1>
        ...
        <div className={"flex items-start justify-between gap-4 text-[10px]"}>
            <p className={"w-[10%]"}>*</p>
            <p className={"flex-grow"}>The % Daily Value (DV) tells you how much a nutrient in a serving of food contributes to a daily diet. 2,000
