...
export default function RecipeLabel({recipe}: Props) {
    return <div className={"flex flex-col w-[325px] h-full bg-[#fafafa] border-main-gray border-[1px] rounded-md py-4 px-3"}>
        ...
        <div className={"flex-grow border-[1px] border-black p-2"}>
            <h1 className={"text-3xl font-bold text-black border-b-[1px] border-black mb-2"}>Nutrition Facts</h1>
            ...
            <div className={"flex items-start justify-between gap-4 text-[10px]"}>
                <p className={"w-[10%]"}>*</p>
                <p className={"flex-grow"}>The % Daily Value (DV) tells you how much a nutrient in a serving of food contributes to a daily diet. 2,000 calories a day is used for general nutrition advice.</p>
            </div>
        </div>
    </div>
}